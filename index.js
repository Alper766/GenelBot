...
.setCustomId('form')
.setTitle('Dark Development- Destek Sistemi!')
...
const embed = new EmbedBuilder()
.setTitle("Dark Development - Kullanıcı Paneli!")
...
.setCustomId('form13')
.setTitle('Dark Development - Menülü Rol Alma Sistemi!')
...
value: "s2"
    ...
    const embed = new EmbedBuilder()
    .setTitle("Dark Development - Rol Alma Sistemi!")
...
client.on("interactionCreate", async (interaction, message) => {
  ...
  if(interaction.customId === "yardım") {
    ...
    let message = interaction.message.id
      ...
      .setTitle("Dark Development - Moderasyon Sistemi!")
    ...
    if (interaction.values[0] == "kullanıcı") { 
      ...
      const embed = new Discord.EmbedBuilder()
    .setTitle("Dark Development - Kullanıcı Sistemi!")
  ...
  .setColor("#ff0000")
    ...
    if (interaction.values[0] == "giveaway") {
      ...
      const embed = new Discord.EmbedBuilder()
    .setTitle("Dark Development - Çekiliş Sistemi!")
...
.setCustomId('formaq')
.setTitle('Dark Development - Başvuru Formu!')
